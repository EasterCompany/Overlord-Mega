...
from modules.elang.reflask import _test_render_ejs
  ...
  Function_tests = (
    ...
    (
      ...
      [
        ...
        (webStr, "", ""),
        # EJS FILE TESTS --------:
        # no doctype decleration returns failed
        #(_test_render_ejs, "fail"),
        # doctype decleration returns passed & empty string
        #(_test_render_ejs, "!DOCTYPE`etml`")
      ]
    ),
  )
